...
import { Check, Send, House, User, Folders, Package, Inbox, Upload, ArrowRightCircle, CornerDownLeft, ClipboardCheck, Truck, FileText, FormInput, History, Factory, ShieldCheck } from 'lucide-react';
